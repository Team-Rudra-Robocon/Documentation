...
As this is a plugin inside ROS , we don't need to install a seperate package or a seperate executable file for it , use the following commands to install it . 
